...
<html>
    <head>
        ...
        <title>Register Properties</title>
        <s:head/>
        <style type="text/css">
    ...
    <body>
        ...
        <div class="container ">
            <div class="jumbotron text-center">
                <h1>Create New Properties</h1>
                <s:form action="registerProp" method="POST" id="register" enctype="multipart/form-data">
                    <s:textfield name="propName" label="Name*"/>
                    <s:textfield name="propQuantity" label="Quantity*"/>
                    <s:file name="propImage" label="Image" accept="image/*"/>
                    <s:textarea name="propDescription" label="Description"/>
